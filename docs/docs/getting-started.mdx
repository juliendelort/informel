...
<head>
    ...
    <meta name="twitter:site" content="@informel_js" />
    <meta name="twitter:title" content="informel is a Web Component that wraps your native HTML forms and gives them super powers." />
    <meta name="twitter:description" content="informel is a Web Component that wraps your native HTML forms and gives them super powers." />
    <meta name="twitter:image" content="https://informel.site/img/logo.png" />
    <meta name="twitter:image:alt" content="informel logo" />
</head>
...
<img src="img/Twitter-logo.svg" width="24" align="center"/>&nbsp;Follow on <a href="https://twitter.com/informel_js">Twitter</a>!
...
On top of that, `informel` accepts custom validation rules, as well as custom error messages. For more information, see [validation rules & error messages](/validation-rules).
