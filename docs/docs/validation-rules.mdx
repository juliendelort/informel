...
<iframe width="100%" height="300" src="//jsfiddle.net/juliendelort/cs9uqpt3/11/embedded/result,html,js" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
When adding the `error-disable-submit` attribute on `<inform-el />`, the submit button is automatically disabled until all fields are valid:
